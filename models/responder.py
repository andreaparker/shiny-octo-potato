...
def generate_response(images, query, session_id, resized_height=280, resized_width=280, model_choice='qwen'):
    ...
    try:
        ...
        if model_choice == 'qwen':
            ...
            try:
                #query = "Answer the following question based on the provided images. Be sure to include section numbers in your response. If the question is not answered in the images, then simply say so and do not make up an answer. " + query
                
                #query = "Include any relevant section names and numbers" + query
